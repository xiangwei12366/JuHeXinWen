...
public class DrawerView implements OnClickListener {
	...
	private void initView() {
		night_mode_btn = (SwitchButton) localSlidingMenu
				.findViewById(R.id.night_mode_btn);
		night_mode_text = (TextView) localSlidingMenu
		...
		night_mode_btn
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						// TODO Auto-generated method stub
						if (isChecked) {
							night_mode_text.setText(activity.getResources()
		...
		if (night_mode_btn.isChecked()) {
			night_mode_text.setText("夜间模式");
		} else {
			night_mode_text.setText(activity.getResources().getString(
