...
public abstract class BaseFragment extends Fragment {
	private final static int REFRESH_COMPLETE = 0X110;
	...
	// System.out.println("XXXXXXXXXXXXXXX刷新!!!!=================");
	// break;
	// }
	// }
	// };
...
//	}
	...
	public void initCityChannel() {
		View headview = LayoutInflater.from(activity).inflate(
				R.layout.city_category_list_tip, null);
		TextView chose_city_tip = (TextView) headview
				.findViewById(R.id.chose_city_tip);
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				notify_view_text.setText(String.format(
						getString(R.string.ss_pattern_update), 10));
